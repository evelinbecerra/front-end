 ...
 */
 ...
 function MTWInicioCtrl($http){
     var self = this;

     self.miVariable = "Hola desde mi controlador";
     self.miArray = {
     ...
     self.localidadItem = {};
     self.localidadesList = [];

     self.refreshLocalidades = function(criterio){
        if( criterio.length > 4 ){
            return $http.get('http://localhost:3002/api/catalogos/getLocalidadesByCriterio/11/20/' + criterio).then(function(response){
                self.localidadesList =  response.data.result;
            }).catch(function(err){
                console.log(err);
            });
        }
...
angular
    ...
    .controller('MTWInicioCtrl', MTWInicioCtrl);
