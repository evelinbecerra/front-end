...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
    ...
    //ocLazyLoad carga de manera dinamica los pluging que se necesitan en cada pagina para no hacer pesada la carga
    ...
    $stateProvider
        ...
        .state('mtw.inicio',{
            url: "/mtw.inicio",
            templateUrl: "views/mtw/inicio.html",
            controller: 'MTWInicioCtrl',
            controllerAs: 'mtwin',
            resolve: {
